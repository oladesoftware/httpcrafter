...
## [ [0.5.0](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/0.5.0) ] - 2026-09-02
...
- **BREAKING CHANGE** // delete `RouterFacade` introduced in release [0.4.0](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.4.0)
- **BREAKING CHANGE** // remove all interfaces because their impose a contract instead of offer tools

## [ [0.4.0](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.4.0) ] - 2025-07-02
...
## [ [0.3.0](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.3.0) ] - 2025-07-01
...
## [ [0.2.2](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.2.2) ] - 2025-01-14

### Changed

- Set `?` to allow nullable for `name` parameter in `Router->addRoute()`

## [ [0.2.1](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.2.1) ] - 2025-01-02

### Changed

- Set PHP minimum requirement to PHP 8.2 and greater

## [ [0.2.0](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.2.0) ] - 2024-12-09

### Added

- Redirection method to `Response` class (`redirect()`) supporting HTTP 301 and 302 status codes

## [ [0.1.3](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.1.3) ] - 2024-10-10
...
## [ [0.1.2](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.1.2) ] - 2024-10-08
...
## [ [0.1.1](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.1.1) ] - 2024-10-07

### Fixed

- `Content-Length` calculation based on content type

## [ [0.1.0](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.1.0) ] - 2024-10-07

### Added

- `Router` class (from archived [oladesoftware/router](https://git.olade.group/oladesoftware/router)) at `src/Router/Router.php`
...
## [ [0.0.3](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.0.3) ] - 2024-06-20
...
## [ [0.0.2](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.0.2) ] - 2024-06-05
...
## [ [0.0.1](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.0.1) ] - 2024-05-26

### Fixed

- Return value type for `getServer()` function in `Request` class

## [ [0.0.0](https://git.olade.group/oladesoftware/httpcrafter/releases/tag/v0.0.0) ] - 2024-05-23
